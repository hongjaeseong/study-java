...
public class C03BitArith {
	...
	public static void main(String[] args) {
		...
		System.out.println("AND 비트 연산 결과 : " + num3); // AND 비트 연산 결과 : 4
		System.out.println("OR 비트 연산 결과 : " + num4); // OR 비트 연산 결과 : 31
		System.out.println("XOR 비트 연산 결과 : " + num5); // XOR 비트 연산 결과 : 27
		System.out.println("NOT 비트 연산 결과 : " + num6); // NOT 비트 연산 결과 : -16
